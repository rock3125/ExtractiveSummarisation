...
public class Undesirables {
    ...
    private final HashSet<String> undesirableSet;
    ...
    // return true if the string passed in is null or an undesirable text
    ...
    private final String[] undesirableList = new String[]{
            // articles
            "the", "a", "an", "not",
    ...
    private final String[] specialCharacterList = {
